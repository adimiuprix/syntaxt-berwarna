...
;hljs.registerLanguage("css",e)})();/*! `nestedtext` grammar compiled for Highlight.js 11.7.0 */
...
3:"punctuation",5:"string"}}]})})();hljs.registerLanguage("nestedtext",t)})();/*! `r` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})();hljs.registerLanguage("node-repl",a)})();/*! `c` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("plaintext",t)})();/*! `swift` grammar compiled for Highlight.js 11.7.0 */
